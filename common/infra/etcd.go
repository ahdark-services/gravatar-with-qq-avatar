...
func NewEtcdClient(ctx context.Context, vip *viper.Viper, logger *otelzap.Logger) (*clientv3.Client, error) {
	...
	client.KV = namespace.NewKV(client.KV, "gravatar-with-qq-support:")
	client.Watcher = namespace.NewWatcher(client.Watcher, "gravatar-with-qq-support:")
	client.Lease = namespace.NewLease(client.Lease, "gravatar-with-qq-support:")
